...
from common.models import Career, City, Location, File
...
class JobSeekerProfile(InfoBaseModel):
    ...
    gender = models.CharField(max_length=1, choices=variable_system.GENDER_CHOICES, null=True)
    marital_status = models.CharField(max_length=1,
                                      choices=variable_system.MARITAL_STATUS_CHOICES,
                                      default=variable_system.MARITAL_STATUS_CHOICES[0][0],
                                      null=True)
...
class Resume(InfoBaseModel):
    ...
    position = models.SmallIntegerField(choices=variable_system.POSITION_CHOICES, null=True)
    experience = models.SmallIntegerField(choices=variable_system.EXPERIENCE_CHOICES, null=True)
    academic_level = models.SmallIntegerField(choices=variable_system.ACADEMIC_LEVEL, null=True)
    type_of_workplace = models.SmallIntegerField(choices=variable_system.TYPE_OF_WORKPLACE_CHOICES, null=True)
    job_type = models.SmallIntegerField(choices=variable_system.JOB_TYPE_CHOICES, null=True)
    is_active = models.BooleanField(default=False)
    type = models.CharField(max_length=10, default=variable_system.CV_UPLOAD)
...
class LanguageSkill(InfoBaseModel):
    language = models.SmallIntegerField(choices=variable_system.LANGUAGE_CHOICES)
    level = models.SmallIntegerField(choices=variable_system.LANGUAGE_LEVEL_CHOICES)
...
class Company(InfoBaseModel):
    ...
    employee_size = models.SmallIntegerField(choices=variable_system.EMPLOYEE_SIZE_CHOICES, null=True)
