...
class CustomAdminStite(admin.AdminSite):
    site_header = "FINDJOB ADMINISTRATION"
    site_title = "FindJob site admin"
    ...
    def each_context(self, request):
        context = super().each_context(request=request)
        context["settings"] = {
    ...
    def user_chart(self, request):
        ...
        queryset2 = User.objects \
            .filter(create_at__date_range=[start_date, end_date],
    ...
    def career_chart(self, request):
        ...
        queryset = JobPost.objects.filter(
                ...
                Q(create_at__date__range=[start_date, end_date])) \
            .values("career") \
            .annotate(total=Count("id")) \
            .values("career__name", "total", ) \
            .order_by("-total")[:5]
...
custom_admin_site = CustomAdminStite(name="custom_admin")
